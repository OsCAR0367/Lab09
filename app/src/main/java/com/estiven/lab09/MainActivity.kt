...
import com.estiven.lab09.PantallaPosts
import com.estiven.lab09.PostApiService
import com.estiven.lab09.ScreenPost
import com.estiven.lab09.ui.theme.Lab09Theme
    ...
    fun Contenido(
        ...
        Box(
            ...
            NavHost(
                ...
                composable("posts") { PantallaPosts(navController, servicio) }
                composable(
                    "postsVer/{id}",
